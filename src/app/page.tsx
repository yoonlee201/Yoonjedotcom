...
export default function Page() {
    return (
        <main className="relative h-screen overflow-hidden">
            ...
            <div className={`${false ? "pointer-events-none" : ""} relative z-10 flex min-h-screen w-full justify-center overflow-y-auto pb-0 pt-root-top-md lg:pb-[3.5rem] lg:pt-root-top`}>
